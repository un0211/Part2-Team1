...
팀원들과 함께 코드 컨벤션을 직접 정하고 정해진 규칙을 준수하며 코드를 작성하는 능력을 키울 수 있었습니다. 정해진 컨벤션 덕분에 작업 진행이 원활해졌고, 프로젝트 초기에 요구사항 분석과 코드 컨벤션의 중요성을 깊이 깨닫게 되었습니다. 또한, 혼자 문제를 해결하기 위해 노력하는 것도 중요하지만, 팀원들과 함께 문제를 해결하며 모르는 것을 파악하고 질문하는 자세를 기르는 것도 중요하다는 것을 느꼈습니다. 이 과정에서 다른 팀원의 코드를 이해하는 능력과 자신의 지식을 명확하게 설명하는 능력도 향상시킬 수 있었습니다.더불어, 기존 요구사항에 더해 사용자 경험(UX)을 개선할 수 있는 추가 기능을 고안하면서 프로젝트의 완성도를 높일 수 있었습니다.
